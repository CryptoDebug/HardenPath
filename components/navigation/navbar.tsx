    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-ink/90 backdrop-blur-xl">
      <nav className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8" aria-label="Main">
        <Link className="focus-ring inline-flex items-center gap-3 rounded-md" href="/">
          <span className="grid h-10 w-10 place-items-center rounded-md border border-steel/30 bg-white/5 text-mint shadow-[inset_0_0_18px_rgba(103,216,189,0.08)]">
            <ShieldCheck aria-hidden className="h-6 w-6" />
          </span>
          <span>
            <span className="block text-lg font-black tracking-normal text-white">HardenPath</span>
            <span className="hidden text-[10px] font-bold uppercase tracking-[0.22em] text-steel sm:block">training paths</span>
          </span>
        </Link>

        <div className="hidden items-center rounded-md border border-white/10 bg-white/[0.035] p-1 md:flex">
